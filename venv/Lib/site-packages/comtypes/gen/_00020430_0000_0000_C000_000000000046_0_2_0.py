...
__all__ = [ 'OLE_XPOS_HIMETRIC', 'FONTSTRIKETHROUGH', 'FONTITALIC',
           'OLE_XPOS_CONTAINER', 'FONTBOLD', 'IPicture',
           'OLE_TRISTATE', 'FONTNAME', 'Color',
           'OLE_ENABLEDEFAULTBOOL', 'IFontEventsDisp', 'FONTSIZE',
           'VgaColor', 'StdPicture', 'OLE_XPOS_PIXELS',
           'IPictureDisp', 'Monochrome', 'OLE_HANDLE', 'IFont',
           'Default', 'Picture', 'OLE_YPOS_HIMETRIC',
           'FONTUNDERSCORE', 'OLE_YPOS_PIXELS', 'FontEvents', 'Font',
           'IFontDisp', 'OLE_XSIZE_PIXELS', 'Checked',
           'OLE_YPOS_CONTAINER', 'OLE_XSIZE_CONTAINER',
           'OLE_XSIZE_HIMETRIC', 'OLE_CANCELBOOL',
           'LoadPictureConstants', 'OLE_YSIZE_CONTAINER', 'Unchecked',
           'StdFont', 'OLE_YSIZE_HIMETRIC', 'OLE_COLOR',
           'OLE_YSIZE_PIXELS', 'Gray', 'OLE_OPTEXCLUSIVE']
